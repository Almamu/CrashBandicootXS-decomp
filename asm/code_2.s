...
sub_80004AC: @ 0x080004AC
	...
	cmp r1, #0
	beq _0800050E
	ldr r0, _080004C0 @ =mem_iwram_heap_pointer
	ldr r0, [r0]
	cmp r1, r0
	blo _080004C4
	adds r4, r0, #0
	b _080004C8
	.align 2, 0
_080004C0: .4byte mem_iwram_heap_pointer
_080004C4:
	ldr r0, _08000514 @ =mem_ewram_heap_pointer
	ldr r4, [r0]
_080004C8:
	adds r3, r1, #0
	subs r3, #0x10
...
_0800050E:
	...
	bx r0
	.align 2, 0
_08000514: .4byte mem_ewram_heap_pointer
