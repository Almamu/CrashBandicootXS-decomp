...
sub_80006A8: @ 0x080006A8
	push {r4, r5, r6, lr}
	ldr r0, _080006BC @ =gUnknown_030007DC
	ldrb r0, [r0]
	cmp r0, #0
	beq _080006E0
	ldr r5, _080006C0 @ =gUnknown_030007D8
	ldr r4, _080006C4 @ =gUnknown_03000A58
	ldr r6, _080006C8 @ =gUnknown_03000A5C
	b _080006D0
	.align 2, 0
_080006BC: .4byte gUnknown_030007DC
_080006C0: .4byte gUnknown_030007D8
_080006C4: .4byte gUnknown_03000A58
_080006C8: .4byte gUnknown_03000A5C
_080006CC:
	bl sub_0803A960
_080006D0:
	ldr r0, [r5]
...
_080006E4:
	...
	thumb_func_start sub_80006EC
sub_80006EC: @ 0x080006EC
	ldr r1, _080006F4 @ =gUnknown_030007DC
	movs r0, #0
	strb r0, [r1]
	bx lr
	.align 2, 0
_080006F4: .4byte gUnknown_030007DC

	thumb_func_start sub_80006F8
sub_80006F8: @ 0x080006F8
	ldr r1, _08000710 @ =gUnknown_03000A5C
	str r0, [r1]
	ldr r2, _08000714 @ =gUnknown_03000A58
	ldr r1, _08000718 @ =gUnknown_030007D8
	ldr r1, [r1]
	adds r1, r1, r0
	str r1, [r2]
	ldr r1, _0800071C @ =gUnknown_030007DC
	movs r0, #1
	strb r0, [r1]
	bx lr
	.align 2, 0
_08000710: .4byte gUnknown_03000A5C
_08000714: .4byte gUnknown_03000A58
_08000718: .4byte gUnknown_030007D8
_0800071C: .4byte gUnknown_030007DC

	thumb_func_start sub_8000720
sub_8000720: @ 0x08000720
	push {r4, r5, lr}
	ldr r0, _08000754 @ =gUnknown_030007DD
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800072E
	bl sub_8038B68
_0800072E:
	ldr r5, _08000758 @ =gUnknown_03000A60
	movs r4, #7
_08000732:
	ldr r0, [r5]
	cmp r0, #0
...
_0800073C:
	...
	cmp r4, #0
	bge _08000732
	ldr r1, _0800075C @ =gUnknown_030007D8
	ldr r0, [r1]
	adds r0, #1
	str r0, [r1]
	pop {r4, r5}
	...
	bx r0
	.align 2, 0
_08000754: .4byte gUnknown_030007DD
_08000758: .4byte gUnknown_03000A60
_0800075C: .4byte gUnknown_030007D8

	thumb_func_start sub_8000760
sub_8000760: @ 0x08000760
	ldr r0, _080007A4 @ =gUnknown_030007E0
	ldrh r2, [r0]
	movs r0, #0x10
	ands r0, r2
	lsls r0, r0, #0x10
...
_08000790:
	...
	orrs r1, r0
_0800079C:
	ldr r0, _080007A8 @ =gStaticData_0816A810
	adds r0, r1, r0
	ldrb r0, [r0]
	bx lr
	.align 2, 0
_080007A4: .4byte gUnknown_030007E0
_080007A8: .4byte gStaticData_0816A810

	thumb_func_start sub_80007AC
sub_80007AC: @ 0x080007AC
	ldr r0, _080007D0 @ =0x04000130
	ldrh r1, [r0]
	mvns r1, r1
	lsls r1, r1, #0x10
	lsrs r1, r1, #0x10
	ldr r2, _080007D4 @ =gUnknown_030007E0
	adds r0, r1, #0
	ldrh r3, [r2]
	bics r0, r3
	strh r0, [r2, #2]
	...
	b _080007DA
	.align 2, 0
_080007D0: .4byte 0x04000130
_080007D4: .4byte gUnknown_030007E0
_080007D8:
	movs r0, #1
_080007DA:
	bx lr
...
sub_80007DC: @ 0x080007DC
	ldr r2, _080007E8 @ =gUnknown_030007E0
	movs r1, #0
	strh r1, [r2]
	strh r1, [r2, #2]
	bx lr
	.align 2, 0
_080007E8: .4byte gUnknown_030007E0
...
_080008B0: .4byte 0x80000100
	thumb_func_start sub_80008B4
sub_80008B4: @ 0x080008B4
	subs	r0, r0, r1
	asrs	r0, r0, #8
	adds	r1, r0, #0
	muls	r1, r0
...
sub_80008CC: @ 0x080008CC
	...
	thumb_func_start sub_80008F0
sub_80008F0: @ 0x080008F0
	push {lr}
	lsls r0, r0, #8
	bl sub_803ADB4
	pop {r1}
	...
	thumb_func_start sub_80008FC
sub_80008FC: @ 0x080008FC
	cmp r0, r1
	ble _08000904
	asrs r0, r0, #8
	b _08000906
...
_08000906:
	...
	thumb_func_start sub_800090C
sub_800090C: @ 0x0800090C
	push {lr}
	adds r1, r0, #0
	movs r0, #0x80
	lsls r0, r0, #9
	...
	thumb_func_start sub_8000924
sub_8000924: @ 0x08000924
	push {lr}
	lsls r0, r0, #0x10
	asrs r0, r0, #8
	lsls r1, r1, #0x10
	...
	bx r1
	.align 2, 0
	thumb_func_start sub_800093C
sub_800093C: @ 0x0800093C
	lsls	r0, r0, #16
	asrs	r0, r0, #16
	lsls	r1, r1, #16
	asrs	r1, r1, #16
	...
	thumb_func_start sub_800094C
sub_800094C: @ 0x0800094C
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r3, r0, #0
	adds r6, r1, #0
...
_08000A94:
	...
	thumb_func_start sub_8000AA8
sub_8000AA8: @ 0x08000AA8
	push {r4, r5, r6, lr}
	sub sp, #0xc
	adds r4, r0, #0
	adds r5, r1, #0
...
_08000AC8:
	lsls r0, r0, #2
	ldr r1, _08000AD4 @ =_08000AD8
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08000AD4: .4byte _08000AD8
_08000AD8: @ jump table
	.4byte _08000C8E @ case 0
	.4byte _08000C8E @ case 1
	.4byte _08000C8E @ case 2
	.4byte _08000C8E @ case 3
	.4byte _08000C8E @ case 4
	.4byte _08000C8E @ case 5
	.4byte _08000C8E @ case 6
	.4byte _08000C8E @ case 7
	.4byte _08000C8E @ case 8
	.4byte _08000C8E @ case 9
	.4byte _08000C8E @ case 10
	.4byte _08000C28 @ case 11
	.4byte _08000C3E @ case 12
	.4byte _08000C3E @ case 13
	.4byte _08000C3E @ case 14
	.4byte _08000C3E @ case 15
	.4byte _08000C3E @ case 16
	.4byte _08000C3E @ case 17
	.4byte _08000C3E @ case 18
	.4byte _08000C3E @ case 19
	.4byte _08000C3E @ case 20
	.4byte _08000C8E @ case 21
	.4byte _08000C8E @ case 22
	.4byte _08000C8E @ case 23
	.4byte _08000C8E @ case 24
	.4byte _08000C8E @ case 25
	.4byte _08000C8E @ case 26
	.4byte _08000C8E @ case 27
	.4byte _08000C8E @ case 28
	.4byte _08000C8E @ case 29
	.4byte _08000C8E @ case 30
	.4byte _08000C8E @ case 31
	.4byte _08000C8E @ case 32
	.4byte _08000C8E @ case 33
	.4byte _08000C8E @ case 34
	.4byte _08000C8E @ case 35
	.4byte _08000C8E @ case 36
	.4byte _08000C8E @ case 37
	.4byte _08000C8E @ case 38
	.4byte _08000C8E @ case 39
	.4byte _08000C8E @ case 40
	.4byte _08000C8E @ case 41
	.4byte _08000C8E @ case 42
	.4byte _08000C8E @ case 43
	.4byte _08000C8E @ case 44
	.4byte _08000C8E @ case 45
	.4byte _08000C8E @ case 46
	.4byte _08000C8E @ case 47
	.4byte _08000C8E @ case 48
	.4byte _08000C8E @ case 49
	.4byte _08000C8E @ case 50
	.4byte _08000C80 @ case 51
	.4byte _08000C8E @ case 52
	.4byte _08000C8E @ case 53
	.4byte _08000C8E @ case 54
	.4byte _08000C8E @ case 55
	.4byte _08000C8E @ case 56
	.4byte _08000C8E @ case 57
	.4byte _08000C8E @ case 58
	.4byte _08000C8E @ case 59
	.4byte _08000C8E @ case 60
	.4byte _08000C8E @ case 61
	.4byte _08000C6E @ case 62
	.4byte _08000C78 @ case 63
	.4byte _08000C8E @ case 64
	.4byte _08000C8E @ case 65
	.4byte _08000C8E @ case 66
	.4byte _08000C8E @ case 67
	.4byte _08000C8E @ case 68
	.4byte _08000C8E @ case 69
	.4byte _08000C8E @ case 70
	.4byte _08000C8E @ case 71
	.4byte _08000C8E @ case 72
	.4byte _08000C8E @ case 73
	.4byte _08000C8E @ case 74
	.4byte _08000C8E @ case 75
	.4byte _08000C8E @ case 76
	.4byte _08000C8E @ case 77
	.4byte _08000C58 @ case 78
	.4byte _08000C8E @ case 79
	.4byte _08000C8E @ case 80
	.4byte _08000C8E @ case 81
	.4byte _08000C8E @ case 82
	.4byte _08000C80 @ case 83
_08000C28:
	add r0, sp, #4
	str r0, [sp]
	adds r0, r4, #0
...
_08000D74:
	...
	thumb_func_start sub_8000D80
sub_8000D80: @ 0x08000D80
	adds	r3, r0, #0
	movs	r2, #0
	ldrb	r0, [r3, #0]
	cmp	r0, #0
...
sub_8006700: @ 0x08006700
	...
	thumb_func_start sub_8006714
sub_8006714: @ 0x08006714
	push {r4, lr}
	adds r4, r0, #0
	bl sub_80006A8
	ldr r0, _08006760 @ =gUnknown_030012B8
	ldr r0, [r0]
	bl sub_8006DC8
	...
	bx r0
	.align 2, 0
_08006760: .4byte gUnknown_030012B8
...
_0800679C:
	...
	thumb_func_start sub_80067A4
sub_80067A4: @ 0x080067A4
	push {lr}
	movs r0, #0x3f
	movs r1, #0x43
	movs r2, #1
	...
	thumb_func_start sub_80067B4
sub_80067B4: @ 0x080067B4
	push {lr}
	movs r0, #0x3e
	movs r1, #0x42
	movs r2, #0
	...
	thumb_func_start sub_80067C4
sub_80067C4: @ 0x080067C4
	push {lr}
	movs r0, #0x3d
	movs r1, #0x41
	movs r2, #2
	...
	thumb_func_start sub_80067D4
sub_80067D4: @ 0x080067D4
	push {lr}
	movs r0, #0x3c
	movs r1, #0x40
	movs r2, #3
	...
	thumb_func_start sub_80067E4
sub_80067E4: @ 0x080067E4
	ldrb r0, [r0]
	lsls r0, r0, #0x19
	lsrs r0, r0, #0x19
	bx lr
...
sub_80067EC: @ 0x080067EC
	push {r4, r5, lr}
	movs r5, #0
	ldr r1, _0800681C @ =gStaticData_0816C86C
	adds r4, r1, #0
	adds r4, #0x10
	adds r3, r0, #0
	movs r1, #0x13
...
_0800680A:
	...
	bx r1
	.align 2, 0
_0800681C: .4byte gStaticData_0816C86C

	thumb_func_start sub_8006820
sub_8006820: @ 0x08006820
	push {r4, r5, r6, lr}
	movs r6, #0
	movs r4, #0
	adds r3, r0, #0
...
_0800682A:
	...
	cmp r1, #0
	beq _0800684E
	ldr r2, _08006860 @ =gStaticData_0816C86C
	adds r0, r2, #0
	adds r0, #0xc
	adds r0, r4, r0
	ldr r0, [r0]
...
_0800684E:
	...
	bx r1
	.align 2, 0
_08006860: .4byte gStaticData_0816C86C
...
_0800686E:
	...
	cmp r1, #0
	beq _08006892
	ldr r2, _080068A4 @ =gStaticData_0816C86C
	adds r0, r2, #0
	adds r0, #8
	adds r0, r4, r0
	ldr r0, [r0]
...
_0800692A:
	...
	thumb_func_start sub_800695C
sub_800695C: @ 0x0800695C
	push {r4, lr}
	movs r3, #0
	adds r1, r0, #0
	movs r2, #0x13
...
_08006A44: .4byte 0x040000D4
	...
	thumb_func_start sub_8006A48
sub_8006A48: @ 0x08006A48
	push {r4, r5, lr}
	adds r1, r0, #0
	ldr r2, [r1]
	cmp r2, #0x7f
...
sub_8006A90: @ 0x08006A90
	...
	thumb_func_start sub_8006AAC
sub_8006AAC: @ 0x08006AAC
	ldr r1, _08006AC0 @ =0x040000D4
	adds r0, #0xc
	str r0, [r1]
	movs r0, #0xe0
	lsls r0, r0, #0x13
	str r0, [r1, #4]
	ldr r0, _08006AC4 @ =0x84000100
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	bx lr
	.align 2, 0
...
_08006B2E:
	...
	b _08006B60
	.align 2, 0
_08006B48: .4byte gUnknown_03001290
_08006B4C: .4byte 0x040000D4
_08006B50:
	ldr r0, [r2, #4]
	str r0, [r3]
	ldr r0, [r2]
