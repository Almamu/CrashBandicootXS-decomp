...
_0802304C:
	...
	cmp r0, #0
	bne _0802305E
	ldr r0, _08023068 @ =gUnknown_03001318
	ldr r0, [r0]
	bl sub_8028474
_0802305E:
	pop {r4}
	...
	bx r0
	.align 2, 0
_08023064: .4byte 0x0000FFFF
_08023068: .4byte gUnknown_03001318

	thumb_func_start sub_802306C
sub_802306C: @ 0x0802306C
	push {r4, lr}
	adds r4, r0, #0
	adds r1, r4, #0
	adds r1, #0xa9
...
_080230F8:
	...
	bx r0
	.align 2, 0
_08023100: .4byte 0x0000FFFF

	thumb_func_start sub_8023104
sub_8023104: @ 0x08023104
	movs r1, #0xdc
	lsls r1, r1, #1
	adds r0, r0, r1
	ldr r0, [r0]
...
sub_8023110: @ 0x08023110
	...
	thumb_func_start sub_8023118
sub_8023118: @ 0x08023118
	adds r0, #0x84
	str r1, [r0]
	bx lr
	.align 2, 0
...
sub_8023128: @ 0x08023128
	...
	thumb_func_start sub_8023130
sub_8023130: @ 0x08023130
	adds r0, #0x84
	ldr r0, [r0]
	bx lr
	.align 2, 0
...
sub_8023138: @ 0x08023138
	...
	thumb_func_start sub_8023140
sub_8023140: @ 0x08023140
	adds r0, #0xac
	ldr r2, [r0]
	adds r2, r2, r1
	str r2, [r0]
	...
	thumb_func_start sub_802314C
sub_802314C: @ 0x0802314C
	adds r0, #0xc0
	ldr r2, [r0]
	orrs r2, r1
	str r2, [r0]
...
sub_8023158: @ 0x08023158
	...
	thumb_func_start sub_8023168
sub_8023168: @ 0x08023168
	movs r1, #0x11
	rsbs r1, r1, #0
	ldrb r2, [r0, #2]
	ands r1, r2
	...
	thumb_func_start sub_8023184
sub_8023184: @ 0x08023184
	movs r1, #0x40
	ldrb r2, [r0, #2]
	orrs r1, r2
	strb r1, [r0, #2]
	...
	thumb_func_start sub_8023190
sub_8023190: @ 0x08023190
	movs r1, #0x20
	ldrb r2, [r0, #2]
	orrs r1, r2
	strb r1, [r0, #2]
	...
	thumb_func_start sub_802319C
sub_802319C: @ 0x0802319C
	movs r1, #0x10
	ldrb r2, [r0, #2]
	orrs r1, r2
	strb r1, [r0, #2]
	...
	thumb_func_start sub_80231A8
sub_80231A8: @ 0x080231A8
	movs r1, #0x80
	ldrb r2, [r0, #2]
	orrs r1, r2
	strb r1, [r0, #2]
	...
	thumb_func_start sub_80231B4
sub_80231B4: @ 0x080231B4
	ldrb r0, [r0, #2]
	lsls r0, r0, #0x19
	lsrs r0, r0, #0x1f
	bx lr

	thumb_func_start sub_80231BC
sub_80231BC: @ 0x080231BC
	ldrb r0, [r0, #2]
	lsls r0, r0, #0x1a
	lsrs r0, r0, #0x1f
	bx lr

	thumb_func_start sub_80231C4
sub_80231C4: @ 0x080231C4
	ldrb r0, [r0, #2]
	lsls r0, r0, #0x1b
	lsrs r0, r0, #0x1f
	bx lr
...
MainLoop: @ 0x08026EEC
	...
	bl sub_8037620
	bl sub_80371B4
	ldr r1, _08026F34 @ =gUnknown_03000868
	str r0, [r1]
	bl sub_80375EC
	ldr r0, [r4]
	bl sub_8023658
...
_08026F1A:
	...
	b _08026F1A
	.align 2, 0
_08026F30: .4byte gUnknown_030012C0
_08026F34: .4byte gUnknown_03000868

	thumb_func_start sub_8026F38
sub_8026F38: @ 0x08026F38
	ldr r2, _08026F4C @ =gUnknown_03000850
	ldr r1, _08026F50 @ =gUnknown_03000868
	ldr r1, [r1]
	lsls r1, r1, #2
	adds r1, r1, r2
	ldr r1, [r1]
	...
	bx lr
	.align 2, 0
_08026F4C: .4byte gUnknown_03000850
_08026F50: .4byte gUnknown_03000868
...
_08027082:
	...
	thumb_func_start sub_8027088
sub_8027088: @ 0x08027088
	adds r2, r0, #0
	movs r0, #0
	strb r0, [r2]
	movs r3, #0
...
_08027096:
	...
	thumb_func_start sub_80270A8
sub_80270A8: @ 0x080270A8
	push {lr}
	adds r2, r0, #0
	movs r0, #1
	ands r0, r1
...
_080270BA:
	...
	thumb_func_start sub_80270C0
sub_80270C0: @ 0x080270C0
	adds r2, r0, #0
	movs r0, #0
	strb r0, [r2]
	movs r3, #0
...
_080270CE:
	...
	thumb_func_start sub_80270E0
sub_80270E0: @ 0x080270E0
	push {r4, r5, lr}
	adds r3, r0, #0
	adds r5, r1, #0
	adds r4, r2, #0
	...
	cmp r1, r0
	beq _08027100
	ldr r0, _08027108 @ =gUnknown_0300086C
	ldr r2, [r0]
	adds r2, r4, r2
	adds r0, r3, #0
	adds r1, r5, #0
...
_08027100:
	...
	bx r0
	.align 2, 0
_08027108: .4byte gUnknown_0300086C

	thumb_func_start sub_802710C
sub_802710C: @ 0x0802710C
	push {lr}
	ldr r2, _0802711C @ =gStaticData_087E4CB4
	str r2, [r0, #0x18]
	bl sub_80088F0
	pop {r0}
	bx r0
	.align 2, 0
_0802711C: .4byte gStaticData_087E4CB4

	thumb_func_start sub_8027120
sub_8027120: @ 0x08027120
	push {r4, lr}
	adds r4, r0, #0
	bl sub_8008904
	ldr r0, _08027134 @ =gStaticData_087E4CB4
	str r0, [r4, #0x18]
	adds r0, r4, #0
	pop {r4}
	pop {r1}
	bx r1
	.align 2, 0
_08027134: .4byte gStaticData_087E4CB4
...
_080274E8: .4byte 0x85000009
	...
	thumb_func_start sub_80274EC
sub_80274EC: @ 0x080274EC
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	ldr r7, _08027520 @ =gUnknown_0300086C
	movs r4, #0
	str r4, [r7]
	ldrb r0, [r5, #0x18]
	cmp r0, #0
...
_08027502:
	adds r0, r5, #0
	bl sub_8027838
	ldr r6, _08027524 @ =gUnknown_030012C0
	ldr r0, [r6]
	bl sub_80233B4
	movs r1, #1
	rsbs r1, r1, #0
	...
	b _08027576
	.align 2, 0
_08027520: .4byte gUnknown_0300086C
_08027524: .4byte gUnknown_030012C0
_08027528:
	ldr r0, [r6]
	bl sub_80232B8
	lsls r0, r0, #0x18
