...
UNITS = [
    ...
    (0x08002D44, None, "overlay_ui"),  # sub_8002D44/sub_8002E20/sub_8002EFC - the SIO send/receive pump trio - parked (real bytes in asm/code_3_1_10_3_2d44.s), NON_MATCHING reconstruction in src/graphics/settings_menu8a2.c - issue #5
    (0x08002FCC, "src/graphics/settings_menu8b.o", "overlay_ui"),  # sub_8002FCC-sub_80035C0 (16 fns) - the SIO-pump handle accessors, the spinner dialog's blocking modal loop and field_8c/field_90 constructor/destructor (sub_800300C/sub_800306C/sub_800312C), the per-frame input dispatcher (sub_80031E4) and most of its per-state handlers; matched - issue #5
    (0x08003698, None, "overlay_ui"),  # sub_8003698 - the shared "commit or refresh row" step - parked (real bytes in asm/code_3_1_10_3_3698.s), NON_MATCHING reconstruction in src/graphics/settings_menu8b.c - issue #5
    (0x0800376C, "src/graphics/settings_menu8c.o", "overlay_ui"),  # sub_800376C/sub_8003824/sub_80038D0/sub_800397C - four more per-state input handlers; matched - issue #5
    (0x08003A60, None, "overlay_ui"),  # sub_8003A60 - the state-select label list draw - parked (real bytes in asm/code_3_1_10_3_3a60.s), NON_MATCHING reconstruction in src/graphics/settings_menu8c.c - issue #5
    ...
    (0x08003C90, "src/graphics/settings_menu.o", "overlay_ui"),  # sub_8003C90 (settings-row centered-label draw); matched. Also incl. parked sub_8003B40/sub_8003BDC/sub_8003D3C/sub_80041BC/sub_8004914/sub_80049CC (NON_MATCHING C reconstructions widen this unit past its own real 0x08003D3C end, per the same "parked function" convention as sub_8006600 above) - those six stay raw here, wrapped `.if NON_MATCHING == 0` across asm/code_3_1_10_3_3b40.s/code_3_1_10_4.s/code_3_1_10_5.s
    ...
    (0x0800D040, "src/system/game_loop6.o", "game_loop"),  # GitHub issue #12: sub_800D040 (parked, NON_MATCHING - real bytes in asm/code_3_2_17_d040.s). Recategorized graphics->game_loop for this span: docs/rom_map.md's "Confirmed: a shared physics/collision subsystem, entered from multiple different entity types" investigation directly reads sub_800D040/sub_0800D18C/sub_800E7A8/sub_800EEF0/sub_800F2BC/sub_800F368/sub_800E6B0/sub_800EEF0 as one cohesive subsystem inside the confirmed game_loop zone (0x08006C00-0x0801E578) - see docs/matching/issue-12-physics-collision.md
    ...
    (0x0800E494, "src/system/game_loop7.o", "game_loop"),  # GitHub issue #12: sub_800E494/sub_800E4E4 (parked, NON_MATCHING - real bytes in asm/code_3_2_17_e494.s) - bidirectional linked-list walkers over the same sub_801070C/sub_8010708 "get next"/"get prev" pair docs/rom_map.md ties to sub_0800D18C - see docs/matching/issue-12-physics-collision.md
    ...
    (0x0800FC70, None, "graphics"),  # start of the next still-unexamined chunk past issue #12's range; category left as the pre-existing placeholder pending its own examination
    ...
    (0x08014F8C, "src/graphics/actor_part38.o", "actor"),  # sub_8014F8C (issue #18): a gUnknown_030012F0-list proximity-trigger scan, same "self" action-table object family as actor_part18.o; matched. Also incl. parked sub_8015038 (NON_MATCHING C reconstruction widens this unit past its own real 0x08015038 end, same convention as actor_part18.o) - real bytes in the new asm/code_3_2_17_15038.s
    (0x080151C8, "src/graphics/actor_part38b.o", "actor"),  # sub_80151C8/sub_8015238 (issue #18): same self+0xc/self+0x10 trampoline-pair and state/counter/table-index-trio family; matched. Non-adjacent to actor_part38.o since parked sub_8015038 sits between them. Also incl. parked sub_80152F0 - real bytes in the new asm/code_3_2_17_152f0.s
    (0x08015350, "src/graphics/actor_part38c.o", "actor"),  # sub_8015350-sub_80156B4 (issue #18): more of the same family, incl. two near-identical self+0x29-keyed mgr-trampoline arms (sub_8015460) and several part+0x38-gated trampoline firers; matched. Non-adjacent to actor_part38b.o since parked sub_80152F0 sits between them. Also incl. parked sub_80156EC - real bytes in the new asm/code_3_2_17_156ec.s
    (0x0801574C, "src/graphics/actor_part38d.o", "actor"),  # nullsub_17-sub_8015780 (issue #18): two nullsubs, a couple of tail-call wrappers, and the shared sub_8015780 trampoline-pair-plus-sentinel-store helper called by actor_part18.o's sub_801426C/sub_80142B0; matched. Non-adjacent to actor_part38c.o since parked sub_80156EC sits between them. Also incl. parked sub_80157C4 - real bytes in the new asm/code_3_2_17_157c4.s
    (0x08015840, None, "graphics"),  # sub_8015840-sub_8017A40 - remainder of the still-unexamined core, including further gStaticData_0816BF20 action-table entries; not yet examined
    ...
    (0x0801E640, "src/graphics/graphics_package_1e640.o", "graphics_loading"),  # GitHub issue #30: sub_801E640 (matched) + sub_801E644 (parked, NON_MATCHING, real bytes in asm/code_3_2_17_1e644.s) - the graphics-package scratch buffer's read/write accessors - see docs/matching/issue-30-graphics-loading.md
    ...
    (0x0801E8F8, "src/graphics/graphics_package_1e8f8.o", "graphics_loading"),  # GitHub issue #30: sub_801E8F8 (matched, DMA tile-fill) + sub_801E950 (parked, NON_MATCHING, real bytes in asm/code_3_2_17_1e950.s) - see docs/matching/issue-30-graphics-loading.md
    ...
    (0x0801E990, None, "graphics_loading"),  # remainder of the LoadGraphicsPackage cluster (issue #30) - sound-trigger dispatch plus the "trigger effect"/text-popup-spawner families; left raw, out of scope for this pass - real bytes stay in the new asm/code_3_2_17_1e990.s
    ...
    (0x0802425C, None, "game_loop"),  # remainder of the UpdateGameFrame-MainLoop cluster, still raw - real bytes in the new asm/code_3_2_17_2425c.s
