...
UNITS = [
    ...
    (0x08021BFC, "src/graphics/graphics_loading_21bfc.o", "graphics_loading"),  # GitHub issue #33: sub_8021BFC-sub_8021CE0 matched (sub_800FF0C entity-constructor trampolines) + sub_8021D04 parked (NON_MATCHING, real bytes in asm/code_3_2_17_21d04.s) - see docs/matching/issue-33-0x08021bfc-graphics-loading.md
