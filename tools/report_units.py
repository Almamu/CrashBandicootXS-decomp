...
UNITS = [
    ...
    (0x0800878C, "src/graphics/actor_part7.o", "graphics"),  # sub_800878C/sub_80087A0/sub_80087B4/sub_80087BC/sub_80087C0/sub_80087C8/sub_80087D0/sub_80087F4/sub_80087FC/sub_8008804/sub_800880C/sub_8008814/sub_8008818/sub_800881C/sub_8008824 - two more sub_80083B8-derived keyframe-record byte lookups plus a run of plain part+0x24/+0x28/+0x2d/+0x30/+0x34 field accessors; non-adjacent to actor_part6.o since the parked sub_8008770 sits raw between them; matched. New object, inserted between asm/code_3_2_7.o (now holding just the parked sub_8008770) and the new asm/code_3_2_8.o (starts at sub_8008830, the remainder of the old code_3_2_7.o content)
    (0x08008830, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
