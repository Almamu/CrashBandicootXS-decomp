...
UNITS = [
    ...
    (0x0800697C, "src/graphics/graphics.o", "graphics"),  # incl. AllocVramDmaQueue/sub_8006C28-sub_8006FB4 (a VRAM upload-cursor + tile/palette-bank asset-cache pair) - moved here from the raw game_loop zone below since none of it is game_loop logic (see docs/matching.md)
    (0x08006FC8, None, "game_loop"),  # 94.4 KB main zone, confirmed one cohesive system - docs/rom_map.md "Two big unnamed systems"
