...
UNITS = [
    ...
    (0x08007A48, "src/graphics/actor_part.o", "graphics"),  # sub_8007A48/sub_8007A84 - thin wrappers around sub_80073DC
    (0x08007A98, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
