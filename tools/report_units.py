...
UNITS = [
    ...
    (0x080080C0, "src/graphics/actor_part4.o", "graphics"),  # sub_80080C0/sub_800815C - another AABB-vs-region overlap test (see actor_part3.o's sub_8007FD8) and a keyframe-record-to-tile-cache-id lookup, non-adjacent to actor_part3.o since the parked sub_8008044 sits raw between them; matched. New object, inserted between asm/code_3_2_4.o (ends after sub_8008044's guard) and asm/code_3_2_5.o (starts at sub_8008200, the remainder of the old code_3_2_4.o content). Also incl. parked sub_8008188 (NON_MATCHING C reconstruction widens this unit past its own real 0x08008200 end, per the same "parked function" convention as sub_80073DC above) - sub_8008188 itself stays raw, linked from asm/code_3_2_5.o
    (0x08008200, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
