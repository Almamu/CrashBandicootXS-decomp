...
UNITS = [
    ...
    (0x08007A48, "src/graphics/actor_part.o", "graphics"),  # sub_8007A48 - thin wrapper resolving screen-vs-camera-relative position before calling sub_80073DC
    (0x08007A84, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
