...
UNITS = [
    ...
    (0x08007A48, "src/graphics/actor_part.o", "graphics"),  # sub_8007A48/sub_8007A84/sub_8007A98/nullsub_2/sub_8007AB4 - thin wrappers around sub_80073DC, a conditionally-free helper, an empty stub, and a part-object field initializer. Also incl. parked sub_8007B00 (NON_MATCHING C reconstruction widens this unit past its own real 0x08007B98 end, per the same "parked function" convention as sub_80073DC above)
    (0x08007B98, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
