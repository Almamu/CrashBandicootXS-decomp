...
UNITS = [
    ...
    (0x08007C30, "src/graphics/actor_part2.o", "graphics"),  # sub_8007C30 - a third AABB-for-keyframe builder (see actor_part.o's parked pair above), non-adjacent to actor_part.o since sub_8007B00/sub_8007B98 sit raw between them; matched. New object, inserted between asm/code_3_2_2.o (ends after sub_8007B98) and asm/code_3_2_3.o (starts at sub_8007CF8, the remainder of the old code_3_2_2.o content)
    (0x08007CF8, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
