...
UNITS = [
    ...
    (0x0802A69C, "src/graphics/actor_part39.o", "actor"),  # sub_802A69C-sub_802A7B8 (issue #50): five gUnknown_03000884-forwarder wrappers, InitActorPart (the constructor every other actor_part*.c file already forward-declares), and sub_802A7B8 (the movement-threshold recompute/frame-advance pair); matched - see docs/matching/issue-50-actor-2a69c.md
    (0x0802A88C, None, "actor"),  # UpdateAnimatedActorPart - the OAM draw/scale routine, parked (real bytes in asm/code_3_2_20_8b7c_a88c.s), NON_MATCHING reconstruction in src/graphics/actor_part44.c - see docs/matching/issue-50-actor-2a69c.md
    (0x0802A980, "src/graphics/actor_part45.o", "actor"),  # sub_802A980-sub_802AA08 (issue #50): non-adjacent to actor_part39.o since the parked UpdateAnimatedActorPart sits raw between them - sub_802A980's movement-threshold recompute and a handful of trivial self+0xc/0x1c/0x20/0x24 accessors; matched - see docs/matching/issue-50-actor-2a69c.md
    (0x0802AA0C, None, "actor"),  # sub_802AA0C - a 12-byte little-vector velocity integrator, parked (real bytes in asm/code_3_2_20_8b7c_aa0c.s), NON_MATCHING reconstruction in src/graphics/actor_part40.c - see docs/matching/issue-50-actor-2a69c.md
    (0x0802AA4C, "src/graphics/actor_part41.o", "actor"),  # sub_802AA4C-sub_802AB34 (issue #50): non-adjacent to actor_part39.o since the parked sub_802AA0C sits raw between them - the same self+0x48/0x4c circular-list teardown as sub_802C19C, the gUnknown_03001428/gUnknown_03000888 fixed-slot registry pair, and the gUnknown_03001464-gated palette-cycle DMA cluster's setup pair (sub_802AB08/sub_802AB34); matched - see docs/matching/issue-50-actor-2a69c.md
    (0x0802AB58, None, "actor"),  # sub_802AB58 - the palette-cycle cursor-advance DMA step, parked (real bytes in asm/code_3_2_20_8b7c_ab58.s), NON_MATCHING reconstruction in src/graphics/actor_part42.c - see docs/matching/issue-50-actor-2a69c.md
    (0x0802ABC8, "src/graphics/actor_part43.o", "actor"),  # sub_802ABC8-sub_802ABFC (issue #50): non-adjacent to actor_part41.o since the parked sub_802AB58 sits raw between them - the palette-cycle cluster's remaining seed/arm-disarm pair; matched - see docs/matching/issue-50-actor-2a69c.md
