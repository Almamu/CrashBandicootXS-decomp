...
UNITS = [
    ...
    (0x08007F78, "src/graphics/actor_part3.o", "graphics"),  # sub_8007F78/sub_8007FD8 - visibility/on-screen check and an AABB-vs-region overlap test (see sub_8006FE4 in graphics.o for sub_8007F78's sibling), non-adjacent to actor_part2.o since sub_8007DBC sits raw between them; matched. New object, inserted between asm/code_3_2_3.o (ends after sub_8007DBC's guard) and asm/code_3_2_4.o (starts at sub_8008044, the remainder of the old code_3_2_3.o content)
    (0x08008044, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
