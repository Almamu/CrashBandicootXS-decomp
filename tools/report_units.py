...
UNITS = [
    ...
    (0x08009008, None, "game_loop"),  # sub_8009008 through sub_8009DF4-ish (~28 functions) - the remainder of a large, deeply interconnected AI/collision/physics dispatch system touching gUnknown_030012C0/gUnknown_030012D8, which docs/rom_map.md itself still describes as only partially understood; left raw rather than guess at semantics - docs/rom_map.md "Two big unnamed systems"
