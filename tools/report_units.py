...
UNITS = [
    ...
    (0x08017A44, "src/graphics/actor_part20.o", "graphics"),  # sub_8017A44-sub_8017AAC (issue #22): the same player/action-object family as actor_part18.o/actor_part19.o (self+0xc table pointer, self+0x10 part pointer, packed self+0x14/self+0x18 flag words); matched
    (0x08017AB0, None, "graphics"),  # sub_8017AB0 (issue #22) - a large (~500-instruction) player-vs-camera-viewport state dispatcher; left raw, out of scope for this pass - real bytes stay in the new asm/code_3_2_17_17ab0.s
    (0x08017ECC, "src/graphics/actor_part20b.o", "graphics"),  # sub_8017ECC-sub_8017FE8 (issue #22): self+4 double-pointer-chain record lookups feeding the gStaticData_0816C2D8 per-vector-component trampoline table, plus more self+0xc table-pointer accessors; matched. Non-adjacent to actor_part20.o since the raw sub_8017AB0 sits between them
    (0x08018008, None, "graphics"),  # sub_8018008-sub_80186F0 (issue #22) - a large jump-table player action-state machine (sub_8018008/sub_8018400) plus two high-register-pressure helpers (sub_801865C nearest-target scan, sub_80186F0 spawn-effect constructor); left raw, out of scope for this pass - real bytes stay in the new asm/code_3_2_17_18008.s
    (0x080187FC, "src/graphics/actor_part20c.o", "graphics"),  # sub_80187FC-sub_8018884 (issue #22): a two-state "charge" handler, two more self+0xc table-pointer accessors, and a struct-actor-shaped part's flags/bitmap-set trampoline (same idiom as sub_8007DBC); matched. Non-adjacent to actor_part20b.o since the raw sub_8018008-sub_80186F0 block sits between them
    (0x080188D0, None, "graphics"),  # sub_80188D0 onward (issue #22 chunk boundary) - remainder of the still-unexamined core; not yet examined
