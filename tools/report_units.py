...
UNITS = [
    ...
    (0x08009BE0, None, "game_loop"),  # sub_8009BE0 through sub_8009D5C-ish (~3 functions) - a physics/collision step-probe function (sub_8009BE0, calling still-unexamined sub_8008278/sub_8026628) sitting between two tractable pockets; left raw rather than guess at semantics - docs/rom_map.md "Two big unnamed systems"
