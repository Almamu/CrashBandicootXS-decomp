...
UNITS = [
    ...
    (0x0800697C, "src/graphics/graphics.o", "graphics"),  # incl. AllocVramDmaQueue, formerly sub_8006C00 - moved here from the raw game_loop zone below since it's FreeVramDmaQueue's missing constructor counterpart, not game_loop logic (see docs/matching.md)
    (0x08006C28, None, "game_loop"),  # 94.4 KB main zone, confirmed one cohesive system - docs/rom_map.md "Two big unnamed systems"
