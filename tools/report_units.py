...
UNITS = [
    ...
    (0x080091D4, None, "game_loop"),  # sub_80091D4 through sub_8009868 (~5 functions) - remainder of the AI/collision cluster; left raw rather than guess at semantics - docs/rom_map.md "Two big unnamed systems"
