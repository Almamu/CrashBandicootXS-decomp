...
UNITS = [
    ...
    (0x08007A48, "src/graphics/actor_part.o", "graphics"),  # sub_8007A48/sub_8007A84/sub_8007A98/nullsub_2 - thin wrappers around sub_80073DC plus a conditionally-free helper and an empty stub
    (0x08007AB4, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
