...
UNITS = [
    ...
    (0x08009528, None, "game_loop"),  # sub_8009528 - remainder of the AI/collision cluster; left raw rather than guess at semantics - docs/rom_map.md "Two big unnamed systems"
