...
UNITS = [
    ...
    (0x0800697C, "src/graphics/graphics.o", "graphics"),  # incl. AllocVramDmaQueue/sub_8006C28-sub_8006FB4 (a VRAM upload-cursor + tile/palette-bank asset-cache pair)/sub_8006FC8/nullsub_1/sub_8006FE4/sub_8007048/nullsub_11/sub_80070D4/sub_80070E8/sub_80070EC/sub_800710C/sub_8007110/sub_8007114/sub_8007174 - moved here from the raw game_loop zone below since none of it is game_loop logic (see docs/matching.md)
    (0x0800719C, None, "game_loop"),  # 94.4 KB main zone, confirmed one cohesive system - docs/rom_map.md "Two big unnamed systems"
