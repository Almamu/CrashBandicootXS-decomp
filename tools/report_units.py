...
UNITS = [
    ...
    (0x08008304, "src/graphics/actor_part5.o", "graphics"),  # sub_8008304/sub_8008328/sub_800834C - defer to the already-matched sub_8007114/sub_8006FE4 respectively (forwarding args through unmodified), plus a trivial always-true stub; non-adjacent to actor_part4.o since the parked sub_8008278 sits raw between them; matched. New object, inserted between asm/code_3_2_5.o (ends after sub_8008278's guard) and asm/code_3_2_6.o (starts at sub_8008350, the remainder of the old code_3_2_5.o content)
    (0x08008350, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
