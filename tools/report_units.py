...
UNITS = [
    ...
    (0x080080C0, "src/graphics/actor_part4.o", "graphics"),  # sub_80080C0 - another AABB-vs-region overlap test (see actor_part3.o's sub_8007FD8), non-adjacent to actor_part3.o since the parked sub_8008044 sits raw between them; matched. New object, inserted between asm/code_3_2_4.o (ends after sub_8008044's guard) and asm/code_3_2_5.o (starts at sub_800815C, the remainder of the old code_3_2_4.o content)
    (0x0800815C, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
