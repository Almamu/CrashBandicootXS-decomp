...
UNITS = [
    ...
    (0x08007C30, "src/graphics/actor_part2.o", "graphics"),  # sub_8007C30/sub_8007CF8 - a third and fourth AABB-for-keyframe builder (see actor_part.o's parked pair above), non-adjacent to actor_part.o since sub_8007B00/sub_8007B98 sit raw between them; matched. New object, inserted between asm/code_3_2_2.o (ends after sub_8007B98) and asm/code_3_2_3.o (starts at sub_8007F78, the remainder of the old code_3_2_2.o content). Also incl. parked sub_8007DBC (NON_MATCHING C reconstruction widens this unit past its own real 0x08007F78 end, per the same "parked function" convention as sub_80073DC above)
    (0x08007F78, None, "game_loop"),  # remainder of the 94.4 KB main zone, still raw - docs/rom_map.md "Two big unnamed systems"
