...
UNITS = [
    ...
    (0x08007F78, "src/graphics/actor_part3.o", "graphics"),  # sub_8007F78 - visibility/on-screen check (see sub_8006FE4 in graphics.o for the sibling), non-adjacent to actor_part2.o since sub_8007DBC sits raw between them; matched. New object, inserted between asm/code_3_2_3.o (ends after sub_8007DBC's guard) and asm/code_3_2_4.o (starts at sub_8007FD8, the remainder of the old code_3_2_3.o content)
    (0x08007FD8, None, "game_loop"),  # raw portion before sub_8008618
    (0x08008618, "src/graphics/actor_part4.o", "graphics"),  # sub_8008618 - clamps a requested animation frame against the current 0x1c-byte record's frame count
    (0x08008640, None, "game_loop"),  # remainder of the main zone, still raw - docs/rom_map.md "Two big unnamed systems"
