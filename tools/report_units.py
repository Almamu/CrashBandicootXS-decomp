...
UNITS = [
    ...
    (0x08014F8C, "src/graphics/actor_part28.o", "actor"),  # sub_8014F8C (issue #18): a gUnknown_030012F0-list proximity-trigger scan, same "self" action-table object family as actor_part18.o; matched. Also incl. parked sub_8015038 (NON_MATCHING C reconstruction widens this unit past its own real 0x08015038 end, same convention as actor_part18.o) - real bytes in the new asm/code_3_2_17_15038.s
    (0x080151C8, "src/graphics/actor_part28b.o", "actor"),  # sub_80151C8/sub_8015238 (issue #18): same self+0xc/self+0x10 trampoline-pair and state/counter/table-index-trio family; matched. Non-adjacent to actor_part28.o since parked sub_8015038 sits between them. Also incl. parked sub_80152F0 - real bytes in the new asm/code_3_2_17_152f0.s
    (0x08015350, "src/graphics/actor_part28c.o", "actor"),  # sub_8015350-sub_80156B4 (issue #18): more of the same family, incl. two near-identical self+0x29-keyed mgr-trampoline arms (sub_8015460) and several part+0x38-gated trampoline firers; matched. Non-adjacent to actor_part28b.o since parked sub_80152F0 sits between them. Also incl. parked sub_80156EC - real bytes in the new asm/code_3_2_17_156ec.s
    (0x0801574C, "src/graphics/actor_part28d.o", "actor"),  # nullsub_17-sub_8015780 (issue #18): two nullsubs, a couple of tail-call wrappers, and the shared sub_8015780 trampoline-pair-plus-sentinel-store helper called by actor_part18.o's sub_801426C/sub_80142B0; matched. Non-adjacent to actor_part28c.o since parked sub_80156EC sits between them. Also incl. parked sub_80157C4 - real bytes in the new asm/code_3_2_17_157c4.s
